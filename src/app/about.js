  ...
  return (
    <div id='about' className={styles.about}>
      ...
      <div className={styles.aboutRight}>
        ...
        <p className={styles.aboutBody}>As a graduate from Bloom Institute of Technology (formerly known as Lambda School), and with my years of work experience as a Full Stack Web Developer, I am confident in delivering quality web solutions. Feel free to check out my <span className={styles.highlighted}><Link href='/resume.pdf' target='_blank' rel='noopener noreferrer'>Resume</Link></span> or my growing Portfolio here on this site.</p>
      </div>
    </div>
  )
}